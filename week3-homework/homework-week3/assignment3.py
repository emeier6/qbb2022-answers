...
#
#
# # All copies found here: /Users/cmdb/data/genomes/sacCer3.fa
#
#
# # Bash commands to insert files and for setup:
# # git pull
# # cp /Users/cmdb/cmdb-quantbio/assignments/lab/variant_calling/extra_data/BYxRM.tar.gz .
# # tar -xvzf BYxRM.tar.g
# # cp /Users/cmdb/data/genomes/sacCer3.fa .
#
#
...
# # bwa mem -t 4 -R "@RG\tID:SRR16356854\tSM:SRR16356854" -o SRR16356854.sam c_elegans.PRJNA13758.WS283.genomic.fa.gz SRR16356854_1.subset.fastq.gz SRR16356854_2.subset.fastq.gz &
#
#
# ## bwa mem -o allows to write to output file by writing the name (a ___.sam file) after -o
# ## -R with the adding tags to the sam file, is a needed thing. String witha read group with metadata with information about the read group, ID and sample name
# ## -t tells how many parallel cores to use in the computer (what our computers are capable of - for this comp, 8 cores to run at the same time. Will only use 4 at the time without interfering with other apps)
#     ## The more CPUs we tell to use, the faster it will be (here 4x faster than just 1)
# ## & symbols will run in the background
#
...
#
#
# '''Step 3a: Make sorted bam file samtools sort for variant call input'''
#
...
#
#
# '''Step 3b: Make sorted bam file samtools sort for variant call input'''
...
#
#
# '''STEP 4: Freebayes to compile vcfs'''
...
#
#
# '''STEP 5: Filter variants with vcffilter'''
...
#
#
# '''STEP 6: Decompose haplotypes with vcfprimitive'''
...
#
#
# '''STEP 8: Data analysis with barplotting'''
